...
[assembly: Rage.Attributes.Plugin("LongerFire", Description = "A plugin that makes fires last longer.", Author = "SSStuart")]
...
namespace SSStuartTools
{
    ...
    {
        public static string pluginName = "LongerFire";
                        ...
                        if (nbFirefighters > 0) {
                            ...
                            if (closeFirefighters.Count() > 0)
                            {
                                foreach (Ped firefighter in closeFirefighters)
                                {
                                    ...
                                    {
                                        fire.ElapsedBurnDuration += (float)Settings.FIRE_ELAPSED_TIME_INCREMENT_NPC;
